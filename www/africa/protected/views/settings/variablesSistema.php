...
<div class="tabbable tabs-left">
              <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#lG" data-toggle="tab">Informes</a></li>
                <li class=""><a href="#lH" data-toggle="tab">Reservas</a></li>
...
<?php $this->widget('application.extensions.fckeditor.FCKEditorWidget',array(
	"value"=>Settings::model()->getValorSistema('PLANTILLA_INFORMES'),
    "name"=>'PLANTILLA_INFORMES',         # Attribute in the Data-Model
   ...
   // "toolbarSet"=>'Full',          # EXISTING(!) Toolbar (see: fckeditor.js)
    ...
    "fckBasePath"=>Yii::app()->baseUrl."/fckeditor/",
                ...
                <div class="tab-pane" id="lH">
                   <?=$this->renderPartial('_variablesReserva', array(), true)?>
                </div>
