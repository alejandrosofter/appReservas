...
class Feriados extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombreFeriado', 'length', 'max'=>255),
			array('fecha', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('buscar,id, fecha, nombreFeriado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function esFeriado($fecha)
	{
		...
		$criteria->compare('fecha',$fecha,false);
	...
	public function search()
	{
		...
		$criteria->compare('nombreFeriado',$this->buscar,true,'OR');
